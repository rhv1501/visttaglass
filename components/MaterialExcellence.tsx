    ...
    <section ref={containerRef} id="process" className="w-full relative bg-brand-navy text-white min-h-[300vh]">
      <div className="sticky top-0 w-full h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
          <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-brand-teal via-transparent to-transparent opacity-40" />
        </div>
        ...
        <div className="container relative z-10 mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col">
            <h2 className="text-[clamp(3rem,5vw,5.5rem)] font-heading font-extrabold leading-[1.05] tracking-tighter mb-8">
          ...
          <div className="relative h-[60vh] w-full flex flex-col justify-center">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <span className="text-brand-cyan text-8xl md:text-[12rem] font-heading font-extrabold opacity-20 leading-none mb-4 md:-ml-8">
                    {step.num}
                  </span>
                  <h3 className="text-4xl md:text-5xl font-heading font-bold text-white mb-6 relative z-10">
                    {step.title}
                  </h3>
                  <p className="text-white/70 text-lg md:text-xl leading-relaxed max-w-lg relative z-10">
                    {step.desc}
                  </p>
                </motion.div>
              );
